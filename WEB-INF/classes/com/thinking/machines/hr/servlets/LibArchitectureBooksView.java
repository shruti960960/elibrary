...
import java.io.*;
import java.util.*;
public class LibArchitectureBooksView extends HttpServlet
{
...
String publisher;
int sno=0;
ArchitectureBooksDAO architectureBooksDAO=new ArchitectureBooksDAO();
List<ArchitectureBooksDTO>architectureBooks;
architectureBooks=architectureBooksDAO.getAll();
for(int x=0;x<architectureBooks.size();x++)
{
sno++;
architectureBooksDTO=architectureBooks.get(x);
book_id=architectureBooksDTO.getBookId();
book_name=architectureBooksDTO.getBookName();
author_name=architectureBooksDTO.getAuthorName();
publisher=architectureBooksDTO.getPublisher();
pw.println("<tr>");
