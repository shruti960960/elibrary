...
import java.io.*;
import java.util.*;
public class MechBooksView extends HttpServlet
{
...
pw.println("<a id='left11' href='/elibrary/adminInfo'>AdminInfo</a><br>");
pw.println("<a id='left12' href='/elibrary/librarianInfo'>LibrarianInfo</a><br>");
pw.println("<a id='left13' href='/elibrary/bookInfo.html'>BookInfo</a><br>");
...
mechbooks=MechBooksDAO.getAll();
for(int x=0;x<mechbooks.size();x++)
{
sno++;
mechBooksDTO=mechbooks.get(x);
book_id=mechBooksDTO.getBookId();
book_name=mechBooksDTO.getBookName();
author_name=mechBooksDTO.getAuthorName();
publisher=mechBooksDTO.getPublisher();
pw.println("<tr>");
...
pw.println("<td style='text-align:center'><a href='/elibrary1/editMechBooks?book_id="+book_id+"'>Edit</a></td>");
pw.println("<td style='text-align:center'><a href='/elibrary1/deleteMechBooks?book_id="+book_id+"'>Delete</a></td>");
pw.println("</tr>");
}
