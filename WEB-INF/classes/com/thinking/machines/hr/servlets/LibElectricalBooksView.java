...
import java.io.*;
import java.util.*;
public class LibElectricalBooksView extends HttpServlet
{
...
String publisher;
int sno=0;
ElectricalBooksDAO electricalBooksDAO=new ElectricalBooksDAO();
List<ElectricalBooksDTO>eebooks;
eebooks=ElectricalBooksDAO.getAll();
for(int x=0;x<eebooks.size();x++)
{
sno++;
electricalBooksDTO=eebooks.get(x);
book_id=electricalBooksDTO.getBookId();
book_name=electricalBooksDTO.getBookName();
author_name=electricalBooksDTO.getAuthorName();
publisher=electricalBooksDTO.getPublisher();
pw.println("<tr>");
...
pw.println("<td style='text-align:center'><a href='/elibrary1/editElectricalBooks?book_id="+book_id+"'>Edit</a></td>");
pw.println("<td style='text-align:center'><a href='/elibrary1/deleteElectricalBooks?book_id="+book_id+"'>Delete</a></td>");
pw.println("</tr>");
}
